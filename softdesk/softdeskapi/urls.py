...
urlpatterns = [
    ...
    path('projects/<int:pk_project>/issues/<int:pk_issue>/comments/', views.CommentList.as_view()),
    path('projects/<int:pk_project>/issues/<int:pk_issue>/comments/<int:pk_comment>/', views.CommentDetail.as_view()),
